...
window.FBDietI18N = (() => {
  ...
  const LOCALES = {
    en: {
      ...
      featAlwaysShowBarTitle: 'Keep Bar When Expanded',
      featAlwaysShowBarDesc: 'Keep a fold bar at the top after expanding for quick re-folding',
      featShowFeedTitleTitle: 'Show Feed Title',
      featShowFeedTitleDesc: 'Show author, group, or snippet on the fold bar',
      featMinimizedFoldTitle: 'Minimized Fold Bar (18px)',
      featMinimizedFoldDesc: 'Switch to 18px ultra-slim height (default is 36px)',
      featFoldScopeTitle: 'Fold Only On Home & Search',
      featFoldScopeDesc: 'Only classify and fold on Home, Search and Marketplace; groups, profiles and other pages stay untouched',
    ...
    'zh-TW': {
      ...
      featAlwaysShowBarTitle: '展開後保留頂部列',
      featAlwaysShowBarDesc: '貼文展開或未摺疊時，頂端保留摺疊列以供辨識及隨時再次摺疊',
      featShowFeedTitleTitle: '顯示貼文標題',
      featShowFeedTitleDesc: '在摺疊列上顯示發文者、社團或內文摘錄',
      featMinimizedFoldTitle: '極簡摺疊列 (18px)',
      featMinimizedFoldDesc: '切換為 18px 極簡高度（預設為 36px 舒適高度）',
      featFoldScopeTitle: '僅首頁與搜尋啟用摺疊',
      featFoldScopeDesc: '只在首頁、搜尋與市集分類並摺疊；社團、個人頁等其他頁面維持原生不動',
