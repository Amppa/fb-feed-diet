...
window.FBDietI18N = (() => {
  ...
  const LOCALES = {
    en: {
      ...
      featAlwaysShowBarTitle: 'Keep Fold Bar When Expanded',
      featAlwaysShowBarDesc: 'Keep a fold bar at the top after expanding for quick re-folding',
      featTitleModeTitle: 'Fold Bar Title',
      featTitleModeDesc: 'Show group, author and snippet while the post is folded; expanded bars keep only the badge',
      featTitleModeAlways: 'Always Show',
      featTitleModeWhenFolded: 'Only When Folded',
      featTitleModeNever: 'Always Hide',
      featMinimizedFoldTitle: 'Minimized Fold Bar (18px)',
      featMinimizedFoldDesc: 'Switch to 18px ultra-slim height (default is 36px)',
      featFoldScopeTitle: 'Only Fold on the Whitelist',
      featFoldScopeDesc: 'Home, Search and Marketplace; all other pages stay untouched',
      featProbeTitle: 'Enable Feed Probe (Debug)',
      featProbeDesc: 'Adds a copy-diagnostics button to every feed item',
    ...
    'zh-TW': {
      ...
      featAlwaysShowBarTitle: '展開後保留摺疊列',
      featAlwaysShowBarDesc: '貼文展開或未摺疊時，頂端保留摺疊列以供辨識及隨時再次摺疊',
      featTitleModeTitle: '摺疊列標題',
      featTitleModeDesc: '摺疊時在摺疊列顯示社團、作者與內文摘要；展開後僅保留分類標籤',
      featTitleModeAlways: '永遠顯示',
      featTitleModeWhenFolded: '僅摺疊時顯示',
      featTitleModeNever: '永遠隱藏',
      featMinimizedFoldTitle: '極簡摺疊列 (18px)',
      featMinimizedFoldDesc: '切換為 18px 極簡高度（預設為 36px 舒適高度）',
      featFoldScopeTitle: '僅白名單頁面摺疊',
      featFoldScopeDesc: '首頁、搜尋與市集；其他頁面維持原生不動',
      featProbeTitle: '啟用 Feed 診斷（除錯）',
      featProbeDesc: '在每則貼文旁顯示可複製診斷資訊的按鈕',
