...
function run(c) {
  ...
  const pageKeys = ['optionsTitle', 'optionsSubtitle', 'masterStatusActive', 'masterStatusDisabled', 'itemsFoldedOnDiet', 'reset', 'sectionEngineMode', 'modeProxyTitle', 'modeProxyDesc', 'sectionDietOptions', 'groupAdsTitle', 'groupAdsDesc', 'groupRegularTitle', 'groupRegularDesc', 'groupSuggestedTitle', 'groupSuggestedDesc', 'groupMediaTitle', 'groupMediaDesc', 'groupOtherTitle', 'groupOtherDesc', 'sectionFoldAppearance', 'featMinimizedFoldTitle', 'featAlwaysShowBarTitle', 'featAlwaysShowBarDesc', 'featShowFeedTitleTitle', 'featShowFeedTitleDesc', 'featFoldScopeTitle', 'featFoldScopeDesc', 'featProbeTitle', 'langToggleTitle', 'popupSubtitle', 'optionsBtn'];
