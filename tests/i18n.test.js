...
function run(c) {
  ...
  c.equals('zh-TW mode title', i18n.t('modeLiteTitle'), 'Lite 模式');
  c.equals('en mode title via lang arg', i18n.t('modeLiteTitle', 'en'), 'Lite Mode');
  ...
  const pageKeys = ['optionsTitle', 'optionsSubtitle', 'masterStatusActive', 'masterStatusDisabled', 'itemsFoldedOnDiet', 'reset', 'sectionDietMode', 'modeLiteTitle', 'modeLiteDesc', 'modeFullTitle', 'modeFullDesc', 'sectionDietOptions', 'groupAdsTitle', 'groupAdsDesc', 'groupRegularTitle', 'groupRegularDesc', 'groupSuggestedTitle', 'groupSuggestedDesc', 'groupMediaTitle', 'groupMediaDesc', 'groupOtherTitle', 'groupOtherDesc', 'sectionFoldAppearance', 'featMinimizedFoldTitle', 'featAlwaysShowBarTitle', 'featAlwaysShowBarDesc', 'featTitleModeTitle', 'featTitleModeDesc', 'featTitleModeAlways', 'featTitleModeWhenFolded', 'featTitleModeNever', 'featFoldScopeTitle', 'featFoldScopeDesc', 'featProbeTitle', 'resetAppearanceBtn', 'resetAppearanceDesc', 'langToggleTitle', 'popupSubtitle', 'optionsBtn'];
